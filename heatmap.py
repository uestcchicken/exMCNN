...
def heatmap(den, num, dataset, info):
    ###################################################
    #img_num = num + 600
    ...
    hm2 = HeatMap(data)
    hm2.heatmap(save_as = 'heatalone_' + dataset + '_' + str(img_num) + '_' + info + '_' + str(int(count)) + '.png')
